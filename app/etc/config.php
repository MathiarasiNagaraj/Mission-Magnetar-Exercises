...
return [
    'modules' => [
        ...
        'Exercises_DataPatch' => 1,
        'Exercises_ModuleCreation' => 0,
        'Exercises_PetTypes' => 1,
        'Exercises_Pets' => 1,
        'Exercises_PluginDemo' => 1,
        'Exercises_PreferenceDemo' => 1,
        'Learning_ControllerDemo' => 0,
        'Learning_CustomCheckOut' => 0,
        'Learning_CustomCommand' => 0,
        'Learning_HelloWorld' => 0,
        'Learning_LayoutDemo' => 0,
        'Learning_MyAccount' => 0,
        'Learning_ObserverDemo' => 0,
        'Learning_Pets' => 1,
        'Learning_PluginDemo' => 0,
        'Learning_PreferenceDemo' => 0,
        'Learning_ProductAttribute' => 0,
        'Learning_ResultObject' => 0,
        'Learning_RouterLogger' => 0,
        'Learning_TextBlock' => 0,
        'Learning_TextRender' => 0,
        'Learning_URLBackTracking' => 0,
        'Learning_ViewModelDemo' => 0,
        'PayPal_Braintree' => 1,
